/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/MaLunan/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '关于', link: '/about/' },
      {
        ...
        items: [
          ...
          { text: '工具网站', link: '/pages/c4cd6e/' },
          { text: '软件工具', link: '/pages/925bb7/' },
        ],
      },
      {
        text: '索引',
    ...
    indexImg: {
      ...
      desc: ["Web前端技术博客，积跬步以至千里，积小流以成江海 ———— 致敬爱学习的你", "不举步，越不守栅栏，不迈腿，登不上高山 ——— 开始学习", "这一生波澜壮阔或是不惊都没问题 —— 做好自己"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFade 为 true 生效
    ...
    author: {
      name: 'MaLunan', // 必需
      link: 'https://github.com/MaLunan', // 可选的
    },
  ...
  head: [
    ...
    ['meta', { name: 'baidu-site-verification', content: 'codeva-36bmXKqe8m' }], // 百度统计的站长验证（你可以去掉）
